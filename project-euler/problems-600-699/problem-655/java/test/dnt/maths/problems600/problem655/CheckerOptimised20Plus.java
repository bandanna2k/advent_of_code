    ...
    public void go()
    {
        ...
        while(true)
        {
            int a = Integer.parseInt(new String(new char[] {
                    nextString.charAt(4),  nextString.charAt(3),  nextString.charAt(2), nextString.charAt(1), nextString.charAt(0) } )); // Swapped
            int d = Integer.parseInt(new String(new char[] {
                    nextString.charAt(length - 5), nextString.charAt(length - 4), nextString.charAt(length - 3), nextString.charAt(length - 2), nextString.charAt(length - 1) } ));
