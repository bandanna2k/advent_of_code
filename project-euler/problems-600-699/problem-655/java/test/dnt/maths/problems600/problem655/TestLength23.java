...
public class TestLength23
{
    @Test
    public void test23CharUsingPalindromeExtractor()
    {
        ModuliCalculator moduliA = new ModuliCalculatorImpl(5, 19, BD10000019.intValue());
        ModuliCalculator moduliB = new ModuliCalculatorImpl(6, 13, BD10000019.intValue());
        ModuliCalculator moduliMid = new ModuliCalculatorImpl(1, 12, BD10000019.intValue());
        ModuliCalculator moduliC = new ModuliCalculatorImpl(6, 6, BD10000019.intValue());
